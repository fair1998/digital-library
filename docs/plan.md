...
- [ ] ตั้งค่า timezone / language
- [ ] ตั้งค่า media files สำหรับ development
- [ ] สร้าง apps:
  - [ ] users
  - [ ] books
  - [ ] reservations
...
- [ ] กำหนด field:
  ...
  - created_at
  - updated_at
- [ ] เพิ่ม unique constraint ที่ name
- [ ] เพิ่ม `__str__`

### 1.3 Publisher Model

- [ ] สร้าง model `Publisher`
- [ ] กำหนด field:
  - id
  - name
  - created_at
...
- [ ] สร้างตารางเชื่อม `BookAuthor`
- [ ] ใส่ unique constraint `(book, author)`

### 1.6 BookCategory Relation

- [ ] สร้างตารางเชื่อม `BookCategory`
- [ ] ใส่ unique constraint `(book, category)`
...
- [ ] register model ทั้งหมดใน admin
- [ ] ปรับ list_display
- [ ] ปรับ search_fields
- [ ] ปรับ list_filter
- [ ] ใช้ inline หรือ many-to-many admin editing ตามที่เลือก
- [ ] ปรับ ordering
- [ ] ปรับ readonly fields เช่น created_at, updated_at
- [ ] ทดสอบเพิ่ม/แก้ไข/ลบข้อมูล
