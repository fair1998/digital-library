...
SECRET_KEY = 'django-insecure-7sd95*88vp3pvo*r+x2)r$_+b#f5h4dfs757p-_q_v3jy+i%+y'
...
MAX_BOOKS_PER_USER = 10  # จำนวนหนังสือสูงสุดที่ user หนึ่งคนสามารถยืมพร้อมกันได้
